...
typedef enum PlatformErrorCode {
    ...
    PLATFORM_ERROR_INTERRUPTED = 15,   // Operation was interrupted
    ...
    PLATFORM_ERROR_FILE_OPEN = 303,    // Failed to open file
    PLATFORM_ERROR_FILE_READ = 304,    // Failed to read from file
    PLATFORM_ERROR_FILE_WRITE = 305,   // Failed to write to file
    PLATFORM_ERROR_FILE_SEEK = 306,    // Failed to seek in file
    PLATFORM_ERROR_FILE_LOCKED = 307,  // File is locked by another process
    PLATFORM_ERROR_DIRECTORY_NOT_FOUND = 308,
    PLATFORM_ERROR_DIRECTORY_EXISTS = 309,
    PLATFORM_ERROR_DIRECTORY_ACCESS = 310,
